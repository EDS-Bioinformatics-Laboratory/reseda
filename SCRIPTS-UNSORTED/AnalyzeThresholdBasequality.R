...
# TCRb dataset
all_info=read.csv("AB-RBF126-T_S92_L001.assembled-ATCGATCG-TRB_HUMAN-all_info.csv.rr.all_info.csv", header=T, sep="\t", stringsAsFactors = F)
...
# BCRh dataset
all_info=read.csv("AB-RBF147-B_S143_L001.assembled-ACTGACTG-IGH_HUMAN-all_info.csv.rr.all_info.csv", header=T, sep="\t", stringsAsFactors = F)
...
boxplot(t10$high_qual, t20$high_qual, t30$high_qual, t40$high_qual, names=c("10", "20", "30", "40"), xlab="Base quality threshold", ylab="Read count high quality CDR3")
# for BCRh
boxplot(t10$low_qual, t20$low_qual, t30$low_qual, names=c("10", "20", "30"), xlab="Base quality threshold", ylab="Read count low quality CDR3")
boxplot(t10$high_qual, t20$high_qual, t30$high_qual, names=c("10", "20", "30"), xlab="Base quality threshold", ylab="Read count high quality CDR3")
...
hist(all_info$cdr3_qual_min, breaks=40)
