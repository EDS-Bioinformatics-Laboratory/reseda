...
myanalysis=`echo ${OUTDIR} | perl -ne 's/.*\///; print;'`
mybranch=${RUN}-${myanalysis}
git branch ${mybranch}
...
# Stub for lab journal _README-analysis.md
echo "# Data analysis ${RUN} with RESEDA" > _README-analysis.md
echo "" >> _README-analysis.md
echo "Git repository: reseda" >> _README-analysis.md
echo "" >> _README-analysis.md
echo "Git branch: ${mybranch} (see _GIT.md)" >> _README-analysis.md
echo "" >> _README-analysis.md
echo "## Data analysis" >> _README-analysis.md
echo "" >> _README-analysis.md
echo "According to the documentation in the git repository: [./DOCS/_build/html/](https://github.com/EDS-Bioinformatics-Laboratory/reseda/tree/master/DOCS/_build/html)" >> _README-analysis.md
echo "" >> _README-analysis.md
echo "## Post analysis" >> _README-analysis.md
echo "" >> _README-analysis.md
echo "\`\`\`" >> _README-analysis.md
echo "./report-ALL.sh PARAMETERS" >> _README-analysis.md
echo "python ConcatenateCloneFilesBatch.py PARAMETERS" >> _README-analysis.md
echo "\`\`\`" >> _README-analysis.md
echo "" >> _README-analysis.md
echo "## Notebooks" >> _README-analysis.md
echo "" >> _README-analysis.md
echo "\`\`\`" >> _README-analysis.md
echo "NOTEBOOKS/SampleSimilarity.ipynb" >> _README-analysis.md
echo "NOTEBOOKS/SharedClonesDirection.ipynb" >> _README-analysis.md
echo "\`\`\`" >> _README-analysis.md

# # Upload files
./copy-to-webdav.sh ${WEBDAV}/${OUTDIR}/ _GIT.md _CONTENT.md _README-analysis.md

# Some comment for the one who runs this script
echo "Created directory ${RUN}/${OUTDIR} on the webdav server."
echo "Uploaded _GIT.md _CONTENT.md _README-analysis.md to the webdav server"
echo ""
