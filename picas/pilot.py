...
class ExampleActor(RunActor):
    ...
    def process_token(self, key, token):
        ...
        command = "/usr/bin/time -v " + " ".join(["./execute-all.sh", "-r", js["run"], "-m", js["mids"], "-org", js["organism"], "-cell", js["cell"], "-celltype", js["celltype"], "-mm", str(js["mismatches"]), "-p", js["protocol"], "-o", js["outdir"], "-b", js["barcodes"], "-u", js["umis"]])
